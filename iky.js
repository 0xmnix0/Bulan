...
const { downloadMenu, infoMenu, infoowner, gameMenu, groupMenu, funMenu, wibuMenu, ownerMenu, sewamenu, stickerMenu, otherMenu, rulesBot } = require('./message/help.js')
...
module.exports = ikyy = async (ikyy, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = ikyy.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© ZtBt","listType": "SINGLE_SELECT","sections": list}}, {})
      ...
      // Anti link
        if (isGroup && isAntiLink && !isOwner && !isGroupAdmins && isBotGroupAdmins){
            if (budy.match(/(https:\/\/chat.whatsapp.com)/gi)) {
                reply(`*「 GROUP LINK DETECTOR 」*\n\nKamu Nakal Si Di bilngin Jangan ngrim Link`)
      ...
      mentions(cptl, x, true)
       ...
       // CMD
        ...
        case 'creator':
               ...
               buttons = [{buttonId: '!sourcecode',buttonText:{displayText: 'SC'},type:1},{buttonId:'!infoig',buttonText:{displayText:'INGPO OWNER'},type:1}]
...
Pilih tombol *LIST MENU* untuk menampilkan menu`

               buttons = [{buttonId: `${prefix}command`,buttonText:{displayText: 'LIST MENU'},type:1},{buttonId:`${prefix}rules`,buttonText:{displayText:'RULES'},type:1},{buttonId:`${prefix}sewabot`,buttonText:{displayText:'SEWA'},type:1}]
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '© ZtBt', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
        ...
        case 'command':
               list = []
               listmenu = [`groupmenu`,`wibumenu`,`stickermenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`owner`,`Fax`,`sewabot`]
               ...
               listmsg(from, `${ucapanWaktu}`, `Hai kak ${pushname}, Pilih Menu List Disini`, list)
               break
        case 'antilink':
...
//------------------< Premium >-------------------
       ...
       case 'sewabot':
       case 'iklan':
              ikyy.sendMessage(from, sewamenu(prefix), MessageType.text, {quoted: mek})
             break
//------------------< Sticker Cmd >-------------------
       case 'addcmd': 
       case 'setcmd':
...
if (!q) return reply('Linknya?')
              ...
              imageMsg = (await ikyy.prepareMessageMedia(fs.readFileSync(`./media/Menu.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/Menu.jpg`)})).imageMessage
              buttonsMessage = {footerText:'© Moon', imageMessage: imageMsg,
      ...
      case 'facebook':
             ...
             reply(mess.wait)
             try {
             anu = await fetchJson(`https://zenzapi.xyz/api/downloader/facebook?url=${args[0]}&apikey=nandowangy`)
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1},{buttonId:`${prefix}nhentaibot`,buttonText:{displayText:'NHENTAI BOT'},type:1}]
              ...
              buttonsMessage = {footerText:'©ZtBt', imageMessage: imageMsg,
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
       ...
       case 'sc': 
       case 'src':
              textImg(`Bot ini menggunakan sc : Nino`)
              break
      case 'ping':
      case 'speed':
              timestampe = speed();
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              ikyy.sendMessage('6281916849086@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
...
//------------------< Enable/Disable >-------------------
       ...
       if (!isGroupAdmins && !isOwner)return reply(mess.admin)
              ...
              reply('*「 ANTILINK DI AKTIFKAN 」*\n\nYang Kirim Link Grup Selain Admin Gua Kick')
...
//------------------< Menunya Bang:v >-------------------
      case 'infoig':
             ...
             break
      case 'Fax':
             reply('https://chat.whatsapp.com/GlAuhF2Sh8n4blusjELDrL')
             break
      case 'ownermenu':
